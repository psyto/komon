...
**Local knowledge matters.** The best solutions often come from people who live with the problem, not experts parachuting in. Komon creates a venue where local knowledge has weight.
...
Today, Komon might help fix a pothole faster.

Tomorrow, it could become infrastructure for how communities make decisions—a protocol for aggregating judgment about what to do, not just what's wrong.

The goal isn't to replace government. It's to create a signal that government (and anyone else) can use. When a direction has significant community stake and a high predicted success rate, that's information. It's evidence that people with skin in the game believe this approach will work.
